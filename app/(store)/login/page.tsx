...
import { ArrowRight, Loader2, Lock, Mail, AlertCircle, ShieldCheck, Phone, CheckCircle, RefreshCw } from 'lucide-react';
    ...
    return (
        <Suspense fallback={
            <div className="min-h-screen bg-[#151515] flex flex-col items-center justify-center gap-6">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#C9A84C]">Loading Portal</span>
            </div>
        }>
            <LoginContent />
        </Suspense>
            ...
            >
                ...
                <div className="mb-8 text-center relative z-10">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black tracking-tight uppercase leading-[0.9] mb-3 text-[#F8F3E8]">
                        Account <span className="bg-gradient-to-r from-[#F8F3E8] via-[#E8D48B] to-[#C9A84C] bg-clip-text text-transparent">Login</span>
                    </h1>
                    <p className="text-[#86868B] text-xs font-bold uppercase tracking-[0.2em]">Sign in with Phone, Google or Email</p>
                </div>
                ...
                {authMode === 'email' ? (
                    <>
                        ...
                        <div className="relative flex justify-center text-[9px] font-black uppercase tracking-[0.3em] text-[#86868B] my-8">
                            ...
                            <span className="bg-[#1E1E1E] px-4 relative z-10">Or email & password</span>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-6 relative z-10">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center px-2">
                                    <label className="text-[10px] font-black uppercase tracking-[0.2em] text-[#86868B]">Password</label>
                                    <Link href="/forgot-password" className="text-[10px] font-bold text-[#C9A84C] uppercase tracking-[0.2em] hover:underline">Forgot?</Link>
                                </div>
                                <div className="relative group">
                            ...
                            <form onSubmit={handleVerifyPhoneOtp} className="space-y-6">
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <div className="flex items-center justify-center gap-3">
                                            Verify & Log In <CheckCircle size={18} />
                                        </div>
                                    )}
                                </button>
                ...
                <div className="mt-8 text-center relative z-10 pt-6 border-t border-white/10">
                    <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#86868B]">
                        ...
                        <Link href={`/signup${nextPath !== '/account' ? `?next=${encodeURIComponent(nextPath)}` : ''}`} className="text-[#C9A84C] hover:underline ml-2 font-black">Register Now</Link>
                    </p>
                </div>
            </motion.div>
        </div>
