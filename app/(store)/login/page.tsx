...
import { ArrowRight, Loader2, Lock, Mail, AlertCircle, ShieldCheck, Zap } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#151515] text-[#F8F3E8] flex items-center justify-center p-6 noise-overlay selection:bg-[#C9A84C]/30 relative overflow-hidden">
            ...
            >
                ...
                <div className="mb-10 text-center relative z-10">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black tracking-tight uppercase leading-[0.9] mb-4 text-[#F8F3E8]">
                        Account <span className="bg-gradient-to-r from-[#F8F3E8] via-[#E8D48B] to-[#C9A84C] bg-clip-text text-transparent">Login</span>
                    </h1>
                    <p className="text-[#86868B] text-xs font-bold uppercase tracking-[0.2em]">Sign in with Google or your credentials</p>
                </div>
